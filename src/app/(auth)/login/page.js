...
const ROLE_CONFIG = {
  ...
  carrier: {
    ...
    heading: <>Carrier<br /><span className="text-emerald-400">Partner Portal</span></>,
    description: 'Connect your courier company to the Parcel Uncle network. Accept shipments, manage pickups, track deliveries, and grow your business.',
    features: [
      { icon: Truck, label: 'Fleet Management', desc: 'Manage your fleet & delivery agents' },
      { icon: Globe, label: 'Network Access', desc: 'Receive orders from 1000+ merchants' },
